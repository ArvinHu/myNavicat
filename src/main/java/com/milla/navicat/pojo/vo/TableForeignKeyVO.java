...
public class TableForeignKeyVO {
    ...
    //更新规则
    private EnumTableForeignKeyRule updateRuleCategory;//'cascade',
    //删除规则
    private EnumTableForeignKeyRule deleteRuleCategory;//'restrict',
    ...
    public EnumTableForeignKeyRule getUpdateRuleCategory() {
        return updateRuleCategory;
    }

    public void setUpdateRuleCategory(EnumTableForeignKeyRule updateRuleCategory) {
        this.updateRuleCategory = updateRuleCategory;
    }

    public EnumTableForeignKeyRule getDeleteRuleCategory() {
        return deleteRuleCategory;
    }

    public void setDeleteRuleCategory(EnumTableForeignKeyRule deleteRuleCategory) {
        this.deleteRuleCategory = deleteRuleCategory;
    }
}
